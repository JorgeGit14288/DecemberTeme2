...
<div class="panel panel-red">
    ...
    <div class="panel-body">
        ...
        <button type="button" target="_blank" onclick="location.href = 'postRecargar.htm?amount=5'" target="_blank" class="btn btn-info btn-circle btn-lg"><i class="">$5</i>
        </button>
    ...
    <div class="panel-body">
        <div class="list-group">
            ...
            <a href="historial.htm" class="list-group-item">
                ...
                <span class="pull-right text-muted small"><em><fmt:message key="msg.VerHistorial" /></em>
                </span>
            </a>

            <a href="#" class="list-group-item">
                <i class="fa fa-shopping-cart fa-fw"></i> <fmt:message key="msg.RecargarSaldo" />
                <span class="pull-right text-muted small"><em><fmt:message key="msg.Recargar" /></em>
                </span>
            </a>
